<template>
      <div>
        <form @submit.prevent="onClick">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                         ...
                         <div class="input-field">
                            ...
                            <input type="date" placeholder="Arrival Date" v-model="arrivaldate"  required>
                        </div>
                        <div class="input-field">
                            <label>Departure Date</label>
                            <input type="date" placeholder="Departure Date" v-model="departuredate"  required>
                        </div>
              ...
              <!-- <button type="submit" id="btnn" class="block magenta margin-auto" @click="redirect" >Submit</button> -->
