  ...
  export default{
    ...
    getPosts()
   {
    ...
    .then(( res ) => {
      ...
      //         this.val=data["data"]["users"]["data"];
      //         this.current=data["data"]["users"]["current_page"];
      //          this.total=data["data"]["users"]["total"];
      //            this.nexturl=data["data"]["users"]["next_page_url"];
      //               this.prevurl=data["data"]["users"]["prev_page_url"];
